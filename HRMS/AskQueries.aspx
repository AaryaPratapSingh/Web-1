<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AskQueries.aspx.cs" Inherits="HRMS.AskQueries" %>
...
<div class="content-body">
    <div class="container-fluid mt-3">
        ...
        <div class="form-group">
            <label class="form-label" for="TextBox2">Questions</label>
            <asp:TextBox ID="TextBox2" runat="server" TextMode="MultiLine" Rows="4" placeholder="Write Your Question here..." CssClass="form-control"></asp:TextBox>
        </div>
