<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerformanceReport.aspx.cs" Inherits="HRMS.PerformanceReport" %>
        ...
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" CssClass="styled-gridview" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                <Columns>
                    ...
                    <asp:BoundField DataField="Q1" HeaderText="A1" />
                    <asp:BoundField DataField="Q2" HeaderText="A2" />
                    <asp:BoundField DataField="Q3" HeaderText="A3" />
                    <asp:BoundField DataField="Q4" HeaderText="A4" />
                    <asp:BoundField DataField="Q5" HeaderText="A5" />
                    <asp:BoundField DataField="Q6" HeaderText="A6" />
                    <asp:BoundField DataField="Q7" HeaderText="A7" />
                    <asp:BoundField DataField="Q8" HeaderText="A8" />
                    <asp:BoundField DataField="Q9" HeaderText="A9" />
                    <asp:BoundField DataField="Q10" HeaderText="A10" />
                </Columns>
            </asp:GridView>
        </div>
    </div>
