<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageUser.aspx.cs" Inherits="HRMS.ManageUser" %>
...
<div class="content-body">
    ...
    <Columns>
        ...
        <asp:BoundField DataField="URole" HeaderText="Role" />
        <asp:BoundField DataField="Action" HeaderText="Status" />

       
        <asp:TemplateField HeaderText="Actions">
            <ItemTemplate>
                <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="action-button update-button" CommandName="Update" CommandArgument="<%# Container.DataItemIndex %>" />
                <asp:Button ID="btnBlock" runat="server" Text="Block" CssClass="action-button block-button" CommandName="Block" CommandArgument="<%# Container.DataItemIndex %>" />
                <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="action-button delete-button" CommandName="Delete" CommandArgument="<%# Container.DataItemIndex %>" />
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</asp:GridView>
