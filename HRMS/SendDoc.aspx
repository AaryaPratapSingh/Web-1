<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendDoc.aspx.cs" Inherits="HRMS.SendDoc" %>
...
<body>
    <form id="form1" runat="server">
        <a href="SendDoc.aspx">SendDoc.aspx</a>
    <!--*******************
        Preloader start
    ********************-->
    <div id="preloader">
...
<div class="content-body">
    <div class="container-fluid mt-3">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="TextBox1" runat="server" placeholder="Enter recipient Email" CssClass="form-control"></asp:TextBox>
        </div>

        <div class="form-group">
            <label class="form-label" for="DropDownList1">Documents</label>
