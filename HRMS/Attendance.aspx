<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Attendance.aspx.cs" Inherits="HRMS.Attendance" %>
...
<div>
    <h1>Attendance</h1>
    <asp:Label ID="StatusLabel" runat="server" CssClass="status-label" ForeColor="Red"></asp:Label>
    <div class="button-container">
        <asp:Button ID="Button1" runat="server" CssClass="btn btn-check-in" OnClick="Button1_Click" Text="Check In" />
        <asp:Button ID="Button2" runat="server" CssClass="btn btn-check-out" OnClick="Button2_Click" Text="Check Out" />
    </div>
</div>
