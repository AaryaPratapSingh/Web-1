<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewDoc.aspx.cs" Inherits="HRMS.ViewDoc" %>
        ...
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" CssClass="styled-gridview" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                <Columns>
                    ...
                    <asp:BoundField DataField="Attachments" HeaderText="File Path" />

                    
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                            <asp:Button ID="btnView" runat="server" Text="View" CssClass="action-button view-button" CommandName="View" CommandArgument='<%# Eval("Attachments") %>' />
                            <asp:Button ID="btnDownload" runat="server" Text="Download" CssClass="action-button download-button" CommandName="Download" CommandArgument='<%# Eval("Attachments") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
