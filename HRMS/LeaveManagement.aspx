<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveManagement.aspx.cs" Inherits="HRMS.LeaveManagement1" %>
...
<div>
    ...
    <asp:GridView ID="GridView1" runat="server" CssClass="styled-gridview" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
        <Columns>
            ...
            <asp:BoundField DataField="NO_ofLeaves" HeaderText="No_of_Leaves" />
            <asp:BoundField DataField="BalanceLaves" HeaderText="Balance_Laves" />
            <asp:TemplateField HeaderText="Action">
                <ItemTemplate>
                    <asp:Button ID="Approved"
                                runat="server"
                                CommandName="Approved"
                                CommandArgument='<%# Eval("ID") + "," + Eval("UEmail") + "," + Eval("From_Date") + "," + Eval("To_Date") + ",Accepted" %>'
                                Text="Approved"
                                CssClass="btn btn-success" />

                    <asp:Button ID="Rejected"
                                runat="server"
                                CommandName="Rejected"
                                CommandArgument='<%# Eval("ID") + "," + Eval("UEmail") %>'
                                Text="Rejected"
